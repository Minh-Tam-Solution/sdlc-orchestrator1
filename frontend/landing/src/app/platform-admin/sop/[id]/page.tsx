 ...
 * @module frontend/landing/src/app/platform-admin/sop/[id]/page
...
export default function SOPDetailPage({ params }: SOPDetailPageProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      router.push("/platform-admin/sop-history");
    } catch (err) {
    ...
    return (
      <div className="space-y-6">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <span>/</span>
          <Link href="/platform-admin/sop-history" className="hover:text-foreground">
            SOP History
          </Link>
          <span>/</span>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <Button onClick={() => router.push("/platform-admin/sop-history")}>
              Back to History
            </Button>
          </CardContent>
        </Card>
