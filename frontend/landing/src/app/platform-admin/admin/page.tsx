...
export default function AdminDashboardPage() {
  ...
  const adminActions = [
    ...
    },
    {
      ...
      href: "/platform-admin/admin/audit-logs",
    },
    {
      title: "System Settings",
      description: "Configure system parameters",
      icon: <Settings className="h-5 w-5" />,
      href: "/platform-admin/admin/settings",
    },
    {
      title: "System Health",
      description: "Monitor service status and metrics",
      icon: <Activity className="h-5 w-5" />,
      href: "/platform-admin/admin/health",
    },
  ];
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <StatCard
            ...
            onClick={() => router.push("/platform-admin/admin/users")}
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <StatCard
            ...
            onClick={() => router.push("/platform-admin/projects")}
          ...
          <StatCard
            ...
            onClick={() => router.push("/platform-admin/gates")}
