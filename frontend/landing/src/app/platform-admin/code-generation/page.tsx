 ...
 * @module frontend/landing/src/app/platform-admin/code-generation/page
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <Button onClick={() => router.push("/platform-admin/app-builder")}>
              Go to App Builder
            </Button>
          </CardContent>
        </Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span>/</span>
        <Link href="/platform-admin/app-builder" className="hover:text-foreground">
          App Builder
        </Link>
        <span>/</span>
        <span className="text-foreground">Code Generation</span>
