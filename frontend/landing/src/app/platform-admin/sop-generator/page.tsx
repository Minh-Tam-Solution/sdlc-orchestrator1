 ...
 * @module frontend/landing/src/app/platform-admin/sop-generator/page
...
export default function SOPGeneratorPage() {
  ...
  const handleViewSOP = () => {
    if (generatedSOP) {
      router.push(`/platform-admin/sop/${generatedSOP.sop_id}`);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <Link href="/platform-admin/sop-history">
