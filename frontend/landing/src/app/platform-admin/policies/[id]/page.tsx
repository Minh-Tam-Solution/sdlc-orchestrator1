 ...
 * @module frontend/landing/src/app/platform-admin/policies/[id]/page
  ...
  if (error || !policy) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <Link href="/platform-admin/policies">
  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="flex items-center gap-2 text-sm text-muted-foreground">
        <Link href="/platform-admin/policies" className="hover:text-foreground">
          Policies
        </Link>
        <span>/</span>
