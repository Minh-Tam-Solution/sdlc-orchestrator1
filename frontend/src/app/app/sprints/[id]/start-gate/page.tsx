/**
 * G-Sprint Gate Page - SDLC Orchestrator
 *
...
import { useGSprintGate, useSprint } from "@/hooks/useSprintGovernance";
import {
    ...
    <div className={`rounded-lg border ${item.is_mandatory ? "border-red-200 bg-red-50/30" : "border-gray-200 bg-white"}`}>
      ...
      >
        <div className="flex items-center gap-3">
          <span className={`text-xl ${getChecklistItemStatusColor(item.status).includes("bg-") ? "" : ""}`}>
            {getChecklistItemStatusIcon(item.status)}
          </span>
          <div>
...
function ApprovalPanel({
  ...
  const gateCanBeApproved = canApproveGate(gate as Parameters<typeof canApproveGate>[0]);
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-6">
      ...
      {/* Waiver Reason (if needed) */}
      {!gateCanBeApproved && gate.items_waived > 0 && (
        <div className="mb-4">
...
export default function GSprintGatePage() {
      ...
      <div className="flex min-h-[400px] items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            {error instanceof Error ? error.message : "The G-Sprint gate could not be loaded."}
          </p>
          <Link
    ...
    <div className="p-6">
      ...
      <div className="mb-6 rounded-xl border border-gray-200 bg-white p-6">
        ...
        <p className="text-sm text-gray-600">
          Complete all mandatory checklist items to approve this gate and start the sprint.
        </p>
      </div>
