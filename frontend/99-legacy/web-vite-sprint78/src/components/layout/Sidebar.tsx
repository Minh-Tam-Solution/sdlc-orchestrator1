 ...
 * Version: 1.2.0
 * Status: ACTIVE - Sprint 77 Teams Navigation
 * Date: 2026-01-18
 ...
 *
 * Changelog:
 * - v1.2.0 (2026-01-18): Add Teams navigation link (Sprint 77)
...
export default function Sidebar() {
  ...
  const handleLogout = () => {
    logout()
    // Redirect to landing page after logout (Next.js on port 8311)
    // In production, this redirects to the root which nginx routes to landing
