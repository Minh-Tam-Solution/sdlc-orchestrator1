 ...
 * Foundation: shadcn/ui Badge component (Tailwind CSS)
 *
 * Description:
 * Badge component with multiple variants for status indicators.
 * WCAG 2.1 AA compliant with accessible colors.
 */
