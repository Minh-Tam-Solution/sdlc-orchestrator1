...
/**
 * Tailwind CSS Configuration - SDLC Orchestrator Landing Page
 *
 * Design Tokens aligned with Design Specification v1.1.0
 * Primary Blue: #2563EB - Brand color
 * Accent Gold: #F59E0B - Founder Plan highlight
 * Success Green: #10B981 - Gate pass indicators
...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      spacing: {
        // Design Spec spacing scale (8px base)
        "18": "4.5rem",
        "22": "5.5rem",
        "26": "6.5rem",
        "30": "7.5rem",
